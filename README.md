...
|----------|---------------------------------------------|
| **Agents & runtime** | [Anthropic — Claude Code](https://claude.com/claude-code) · [Claude Agent SDK](https://github.com/anthropics/claude-agent-sdk-python) · [OpenAI — Codex](https://developers.openai.com/codex) · [Astral — uv](https://docs.astral.sh/uv/) · [Python](https://www.python.org) · [Node.js](https://nodejs.org) · [Rust](https://www.rust-lang.org) · [Pydantic](https://docs.pydantic.dev) · [Rich](https://github.com/Textualize/rich) · local model backends [Ollama](https://ollama.com) · [vLLM](https://github.com/vllm-project/vllm) · [LM Studio](https://lmstudio.ai) |
| **Browser & web collection** | [Playwright](https://playwright.dev) · [Chromium](https://www.chromium.org) · [agent-browser — Vercel Labs](https://github.com/vercel-labs/agent-browser) · [Scrapling](https://github.com/D4Vinci/Scrapling) · [Requests](https://requests.readthedocs.io) · [FlareSolverr](https://github.com/FlareSolverr/FlareSolverr) |
...
| **Threat intelligence & sandboxing** | [VirusTotal](https://www.virustotal.com) · [urlscan.io](https://urlscan.io) · [ANY.RUN](https://any.run) · [GreyNoise](https://www.greynoise.io) · [AbuseIPDB](https://www.abuseipdb.com) · [AlienVault OTX](https://otx.alienvault.com) · [abuse.ch](https://abuse.ch) (URLhaus · ThreatFox · MalwareBazaar) · [CIRCL cve-search](https://www.circl.lu) · [NVD](https://nvd.nist.gov) · [ransomware.live](https://www.ransomware.live) · [MISP](https://www.misp-project.org) · [PublicWWW](https://publicwww.com) |
| **Search engines & ads** | [SerpApi](https://serpapi.com) · [Bright Data SERP API](https://brightdata.com) · [Google Ads Transparency Center](https://adstransparency.google.com) · [Common Crawl](https://commoncrawl.org) |
| **Secrets, code & exposure** | [TruffleHog](https://github.com/trufflesecurity/trufflehog) · [Gitleaks](https://github.com/gitleaks/gitleaks) · [GitHub CLI](https://cli.github.com) · [GrayHatWarfare](https://grayhatwarfare.com) |
...
| **Image, media & vision** | [ExifTool](https://exiftool.org) · [TinEye](https://tineye.com) · [FaceCheck.id](https://facecheck.id) · [FotoForensics](https://fotoforensics.com) · [picarta.ai](https://picarta.ai) · [Tesseract OCR](https://github.com/tesseract-ocr/tesseract) · [FFmpeg](https://ffmpeg.org) · [ImageMagick](https://imagemagick.org) · [RMBG](https://huggingface.co/briaai/RMBG-1.4) · [multix CLI — mrgoonie](https://github.com/mrgoonie/multix-cli) · [Google Gemini](https://ai.google.dev) · [pyzbar](https://github.com/NaturalHistoryMuseum/pyzbar) / [ZBar](https://github.com/mchehab/zbar) |
...
| **Web archives** | [Internet Archive — Wayback](https://web.archive.org) · [archive.today](https://archive.today) · [Common Crawl](https://commoncrawl.org) · [Waymore](https://github.com/xnl-h4ck3r/waymore) |
| **Reporting, diagrams & rendering** | [pandoc](https://pandoc.org) · [TeX Live / XeLaTeX](https://tug.org/texlive/) · [LibreOffice](https://www.libreoffice.org) · [python-docx](https://github.com/python-openxml/python-docx) · [openpyxl](https://openpyxl.readthedocs.io) · [Matplotlib](https://matplotlib.org) · [NumPy](https://numpy.org) · [NetworkX](https://networkx.org) · [Graphviz](https://graphviz.org) · [Mermaid](https://mermaid.js.org) · [PlantUML](https://plantuml.com) · [diagrams](https://diagrams.mingrammer.com) · [CairoSVG](https://cairosvg.org) · [Pillow](https://python-pillow.org) · [jq](https://jqlang.github.io/jq/) · [ASN](https://github.com/nitefood/asn) |
| **Vendored (MIT, trimmed copies)** | [Archify — tt-a1i](https://github.com/tt-a1i/archify) (the HTML report's Blueprint diagram) · [Diagram Design — Cathryn Lavery](https://github.com/cathrynlavery/diagram-design) (editorial entity / topology SVG) · [Diagram AI Generator — carlosmgv02](https://github.com/carlosmgv02/diagram-ai-generator) (cloud-architecture figure) |
| **Standards & frameworks** | [OWASP](https://owasp.org) · [MITRE ATT&CK](https://attack.mitre.org) · [STIX 2.1 (OASIS)](https://oasis-open.github.io/cti-documentation/) · [ICD 203 — Analytic Standards (ODNI)](https://www.dni.gov/files/documents/ICD/ICD-203.pdf) · Admiralty / NATO source-reliability code · [FIRST TLP 2.0](https://www.first.org/tlp/) · [NIST SP 800-61](https://csrc.nist.gov/pubs/sp/800/61/r2/final) · [CWE](https://cwe.mitre.org) |
